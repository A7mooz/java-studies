// Find and display the city, which has the lowest temperature in Aegean.
public class Example5 {
    public static void main(String[] args) {
        ...
        double lowest = temperature[1][0][0][0];

        for (int i = 0; i < 12; i++) 
            for (int j = 0; j < 3; j++) 
                for (int k = 0; k < 9; k++) 
                    if (lowest > temperature[1][k][j][i])
                        lowest = temperature[1][k][j][i];

        for (int i = 0; i < 12; i++) 
            for (int j = 0; j < 3; j++) 
                for (int k = 0; k < 9; k++) 
                    if (lowest == temperature[1][k][j][i])
                        System.out.printf("%s has the lowest temperature in Aegean in %s with %.2f.\n", dim3[1][k], dim1[i], lowest);
    }
}
