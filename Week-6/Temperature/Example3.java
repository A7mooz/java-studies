// Find the average of maximum temperatures of Marmara in July.
public class Example3 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 9; i++)
            average += temperature[0][i][0][6];

        System.out.println("Average maximum temperature of Marmara in July is " + average/9 + ".");
    }
}
