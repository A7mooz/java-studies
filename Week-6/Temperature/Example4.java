// Find and display the average of minimum temperatures of Aegean in January.
public class Example4 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 9; i++)
            average+=temperature[1][i][2][0];

        System.out.println("Average maximum temperature of Aegean in July is " + average/9 + ".");
    }
}
